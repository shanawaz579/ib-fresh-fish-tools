-- ============================================
-- Delete All Bills Script
-- WARNING: This will permanently delete all bills and related data
-- ============================================

-- IMPORTANT: Make sure you have a backup before running this!

-- Step 1: Delete all payment allocations (if any exist)
DELETE FROM payment_allocations;

-- Step 2: Delete all bill other charges (if any exist)
...
-- Verification: Check that all bills are deleted
...
SELECT COUNT(*) as remaining_payment_allocations FROM payment_allocations;
