  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.summary}>
        ...
        {props.previousBalance !== 0 ? <View style={styles.summaryRow}><Text style={styles.summaryLabel}>{props.previousBalance < 0 ? 'Customer credit brought forward' : 'Balance brought forward'}</Text><Text style={styles.summaryValue}>{props.previousBalance < 0 ? '−' : ''}{formatMoney(Math.abs(props.previousBalance), 0)}</Text></View> : null}
